...
# this code uses the Base class and the engine connection variable to drop all existing tables and create any tables that Base mapped, in a class that inherits Base
